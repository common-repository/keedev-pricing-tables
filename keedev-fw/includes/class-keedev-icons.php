...
if ( !class_exists( 'KeeDev_Icons' ) ) {
    class KeeDev_Icons {
        private static $_instance;

        private $fontawesome_version = '4.6.3';
         ...
         * @return string
         */
        public function get_icon_data( $icon_string ) {
            $icon_data = '';
            if ( $icon_string ) {
                ...
                if ( count( $icon_array ) >= 2 ) {
                    ...
                    if ( isset( $this->icons[ $font_name ] ) ) {
                        $icon_key  = array_search( $icon_name, $this->icons[ $font_name ] );
                        $icon_code = '&#x' . str_replace( '\\', '', $icon_key );

                        $icon_data = 'data-font="keedev-' . esc_attr( $font_name ) . '" data-name="' . esc_attr( $icon_name ) . '" data-key="' . esc_attr( $icon_key ) . '" data-icon="' . $icon_code . '"';
                    }
                }
            }
        ...
        public function enqueue_scripts() {
            wp_register_style( 'font-awesome', "//maxcdn.bootstrapcdn.com/font-awesome/{$this->fontawesome_version}/css/font-awesome.min.css", array(), $this->fontawesome_version );
        ...
        public function get_icon( $icon = '', $args = array() ) {
            ...
            if ( $icon ) {
                ...
                if ( $icon_data = $this->get_icon_data( $icon ) ) {
        ...
        public function get_inline_scripts( $slug ) {
            ...
            switch ( $slug ) {
                case 'font-awesome':
                    $css = '[data-font="keedev-FontAwesome"]:before {font-family: \'FontAwesome\' !important;content: attr(data-icon) !important;speak: none !important;font-weight: normal !important;font-variant: normal !important;text-transform: none !important;line-height: 1 !important;font-style: normal !important;-webkit-font-smoothing: antialiased !important;-moz-osx-font-smoothing: grayscale !important;}';
                    break;
                case 'dashicons':
                    $css = '[data-font="keedev-Dashicons"]:before {font-family: \'Dashicons\' !important;content: attr(data-icon) !important;speak: none !important;font-weight: normal !important;font-variant: normal !important;text-transform: none !important;line-height: 1 !important;font-style: normal !important;-webkit-font-smoothing: antialiased !important;-moz-osx-font-smoothing: grayscale !important;}';
            }
...
if ( !function_exists( 'keedev_get_icon' ) ) {
    function keedev_get_icon( $icon = '', $args = array() ) {
        return KeeDev_Icons::instance()->get_icon( $icon, $args );
    }
}

if ( !function_exists( 'keedev_print_icon' ) ) {
    function keedev_print_icon( $icon = '', $args = array() ) {
        wp_enqueue_style( 'font-awesome' );
        wp_enqueue_style( 'dashicons' );
        echo keedev_get_icon( $icon, $args );
    }
}